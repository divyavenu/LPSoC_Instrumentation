...
void InstrumentPowerDue::startADC(){
  ...
  buffer[currentBuffer][0] = SYNC_BLOCK1; //2bytes 5555
  buffer[currentBuffer][1] = SYNC_BLOCK2; //2bytes 5555
  ...
  buffer[nextBuffer][0] = SYNC_BLOCK1;
  buffer[nextBuffer][1] = SYNC_BLOCK2;
